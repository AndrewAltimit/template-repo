#!/bin/bash
# markdown-link-checker installation script
# Installs the fast concurrent link validator for markdown files
...
echo "============================================"
echo "markdown-link-checker Installation"
echo "============================================"
echo ""
...
echo "============================================"
echo ""
echo "Usage: ${BINARY_NAME} [OPTIONS] <PATH>"
echo ""
echo "Examples:"
echo "  ${BINARY_NAME} .                    # Check all markdown in current dir"
echo "  ${BINARY_NAME} docs/                # Check docs directory"
echo "  ${BINARY_NAME} --internal-only .    # Skip external link checks"
echo ""
