...
class CodexClient:
    ...
    def clear_history(self) -> Dict[str, Any]:
        ...
        return cast(Dict[str, Any], self.client.execute_tool("clear_codex_history", {}))

    def get_status(self) -> Dict[str, Any]:
        """Get Codex integration status"""
        return cast(Dict[str, Any], self.client.execute_tool("codex_status", {}))
    ...
    def toggle_auto_consult(self, enable: Optional[bool] = None) -> Dict[str, Any]:
        ...
        return cast(Dict[str, Any], self.client.execute_tool("toggle_codex_auto_consult", params))
