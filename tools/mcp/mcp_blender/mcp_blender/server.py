                    ...
                    "properties": {
                        ...
                        "parameters": {
                            ...
                            "properties": {
                                ...
                                "scale_base": {"type": "number", "default": 1.0},
                                "random_rotation": {"type": "boolean", "default": True},
                                "align_to_normal": {"type": "boolean", "default": False},
                                "instance_object": {"type": "string"},
                                "count_x": {"type": "integer", "default": 5},
                                "count_y": {"type": "integer", "default": 5},
                                "count_z": {"type": "integer", "default": 1},
                                "spacing_x": {"type": "number", "default": 2.0},
                                "spacing_y": {"type": "number", "default": 2.0},
                                "spacing_z": {"type": "number", "default": 2.0},
                                "offset_x": {"type": "number", "default": 2.0},
                                "offset_y": {"type": "number", "default": 0.0},
                                "offset_z": {"type": "number", "default": 0.0},
                                "turns": {"type": "number", "default": 3},
                                "radius": {"type": "number", "default": 5.0},
                                "radius_start": {"type": "number", "default": 0.5},
                                "radius_end": {"type": "number", "default": 3.0},
                                "height": {"type": "number", "default": 2.0},
                                "profile_radius": {"type": "number", "default": 0.1},
                                "amplitude": {"type": "number", "default": 0.5},
                                "frequency": {"type": "number", "default": 2.0},
                                "phase": {"type": "number", "default": 0.0},
                                "axis": {"type": "string", "enum": ["X", "Y", "Z"]},
                                "wave_axis": {"type": "string", "enum": ["X", "Y", "Z"]},
                                "angle": {"type": "number", "default": 3.14159},
                                "strength": {"type": "number", "default": 0.5},
                                "scale": {"type": "number", "default": 5.0},
                                "detail": {"type": "number", "default": 2.0},
                                "roughness": {"type": "number", "default": 0.5},
                                "use_normals": {"type": "boolean", "default": True},
                                "subdivisions": {"type": "integer", "default": 3},
                                "offset": {"type": "number", "default": 1.0},
                                "individual": {"type": "boolean", "default": False},
                                "top_scale": {"type": "number", "default": 1.0},
