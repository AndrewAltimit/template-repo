...
def generate_non_sequential_id(base=100, used_ids=None):
    ...
    from mcp_gaea2.validation.gaea2_format_fixes import generate_non_sequential_id as real_generate_id
...
def fix_property_names(node_type, props):
    """Use the real implementation from gaea2_format_fixes"""
    from mcp_gaea2.validation.gaea2_format_fixes import fix_property_names as real_fix_names
