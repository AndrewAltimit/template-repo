...
The MCP Core module provides shared infrastructure for all MCP servers:
...
> **Note**: Expressive AI agent support (emotions, expression orchestration, personality) has been moved to the [Virtual Character MCP Server](../../mcp_virtual_character/docs/).
