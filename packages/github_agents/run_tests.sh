#!/bin/bash
# Run tests for the github_agents package

set -e

echo "Running tests for github_agents package..."
...
python -m pytest tests/ -v --cov=github_agents --cov-report=term-missing --cov-report=html
