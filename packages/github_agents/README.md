...
- **Multi-Agent Support**: Choose from multiple agents based on your needs (Claude, OpenCode, Gemini, Crush, Codex)
- **Issue Monitoring**: Automatically respond to GitHub issues with agent-generated implementations
- **PR Review Monitoring**: Process review feedback and generate fixes using multiple agents
...
- **Extensible**: Easy to add new agents or monitors
...
cd template-repo/packages/github_agents
...
```python
from github_agents.monitors import PRMonitor
...
```python
from github_agents.agents import OpenCodeAgent, ClaudeAgent
...
python -m pytest tests/ -v --cov=github_agents
