...
class TestSubagentManager:
    ...
    @patch("github_agents.subagents.manager.Path.exists")
    @patch("github_agents.subagents.manager.Path.glob")
    ...
    @patch("github_agents.subagents.manager.get_best_available_agent")
    ...
    @patch("github_agents.subagents.manager.get_best_available_agent")
    @patch("github_agents.subagents.manager.asyncio.get_event_loop")
    ...
    @patch("github_agents.subagents.manager.ClaudeAgent")
    @patch("github_agents.subagents.manager.asyncio.get_event_loop")
...
class TestConvenienceFunctions:
    ...
    @patch("github_agents.subagents.manager.SubagentManager")
    def test_implement_issue_with_tech_lead(self, mock_manager_class):
        """Test tech lead convenience function."""
        from github_agents.subagents.manager import implement_issue_with_tech_lead
    ...
    def test_review_pr_with_qa(self, mock_manager_class):
        ...
        from github_agents.subagents.manager import review_pr_with_qa
