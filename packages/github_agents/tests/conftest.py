...
def mock_board_issue():
    ...
    from github_agents.board.models import Issue, IssuePriority, IssueStatus
...
def mock_agent_claim():
    ...
    from github_agents.board.models import AgentClaim
...
@pytest.fixture
def mock_board_manager(mock_board_config, _mock_github_token):
