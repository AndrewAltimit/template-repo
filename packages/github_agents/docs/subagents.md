...
The agents use specialized personas to handle specific tasks more effectively:
...
3. **Better Context**: agents understand the full project context
...
Different agents may have varying levels of persona support:
