...
Welcome to the GitHub Agents documentation. This package provides automated code generation and review capabilities through agents integrated with GitHub Issues and Pull Requests.
...
# Run tests
pytest tests/ -v --cov=github_agents
