# CLI Reference - GitHub Agents

Complete command-line interface reference for the GitHub Agents package.
...
| `ENABLE_AGENTS` | Enable agent execution | No (default: true) |
