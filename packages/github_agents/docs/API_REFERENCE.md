# API Reference - GitHub Agents

Complete Python API reference for the GitHub Agents package.
...
**Location**: `github_agents.board.manager.BoardManager`
...
**Example:**
```python
from github_agents.board.models import IssuePriority, IssueType, IssueSize
...
**Location**: `github_agents.board.config.BoardConfig`
...
**Location**: `github_agents.board.models`
...
**Location**: `github_agents.monitors.issue.IssueMonitor`
...
**Location**: `github_agents.monitors.pr.PRMonitor`
...
**Location**: `github_agents.agents.base.BaseAgent`
...
**Location**: `github_agents.security.manager.SecurityManager`

#### Usage

```python
from github_agents.security.manager import SecurityManager
