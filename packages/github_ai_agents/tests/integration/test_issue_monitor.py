...
class TestIssueMonitor:
    ...
    @patch("github_ai_agents.monitors.base.run_gh_command")
    @patch("github_ai_agents.config.AgentConfig")
    @patch("github_ai_agents.security.SecurityManager")
    ...
    @patch("github_ai_agents.monitors.base.run_gh_command")
    @patch("github_ai_agents.monitors.issue.asyncio.run")
    @patch("github_ai_agents.config.AgentConfig")
    @patch("github_ai_agents.security.SecurityManager")
