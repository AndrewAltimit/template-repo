...
from github_ai_agents.board.cli import (
    cmd_block,
    cmd_claim,
    cmd_create,
    cmd_graph,
...
from github_ai_agents.board.models import AgentClaim, DependencyGraph, Issue, IssuePriority, IssueStatus, IssueType
...
class TestLoadBoardManager:
    ...
    @patch("github_ai_agents.board.cli.Path")
    @patch("github_ai_agents.board.cli.os.getenv")
...
class TestCmdReady:
    ...
    @pytest.mark.asyncio
    @patch("github_ai_agents.board.cli.load_board_manager")
...
class TestMainCLI:
    ...
    @patch("github_ai_agents.board.cli.sys.argv", ["board-cli"])
    def test_main_no_command(self):
        """Test main with no command."""
        with pytest.raises(SystemExit):
            main()

    @patch("github_ai_agents.board.cli.sys.argv", ["board-cli", "ready", "--limit", "5"])
    @patch("github_ai_agents.board.cli.cmd_ready")
    @patch("github_ai_agents.board.cli.setup_logging")
    ...
    @patch("github_ai_agents.board.cli.sys.argv", ["board-cli", "create", "Test Issue", "--type", "bug"])
    @patch("github_ai_agents.board.cli.cmd_create")
    @patch("github_ai_agents.board.cli.setup_logging")
    ...
    @patch("github_ai_agents.board.cli.sys.argv", ["board-cli", "--verbose", "info", "123"])
    @patch("github_ai_agents.board.cli.cmd_info")
    @patch("github_ai_agents.board.cli.setup_logging")
