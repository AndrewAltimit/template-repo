...
% --- Minted Configuration for Superior Syntax Highlighting ---
\usepackage{minted}
\setminted{
  bgcolor=CodeBg,
  fontsize=\small,
...
% --- Fallback: Enhanced Listings Configuration (if minted unavailable) ---
\lstset{
...
% --- Enhanced Code Block Environments with Minted ---
% Note: These are defined but code blocks in the document use lstlisting
% To use minted, replace \begin{lstlisting} with \begin{minted}{python}
...
% --- Fallback: Traditional Code Box (for listings) ---
