...
\tikzset{
  process/.style={rectangle, rounded corners=3mm, draw=BrandAccent, fill=BrandBlue!10, text width=2.5cm, minimum height=1.2cm, text centered, font=\sffamily},
  gate/.style={rectangle, draw=ResearchOrange, fill=ResearchOrange!15, text width=5cm, minimum height=1.5cm, text centered, font=\sffamily\bfseries},
  arrow/.style={-Stealth, thick, draw=BrandAccent}
}
