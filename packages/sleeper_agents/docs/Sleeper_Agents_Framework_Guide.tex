...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % Stats boxes
  \node[fill=primaryblue!8, rounded corners=5pt, inner sep=8pt] at ([xshift=7.5cm, yshift=-11cm]current page.north west) {
    \begin{tabular}{c}
  ...
  \node[fill=primaryblue!8, rounded corners=5pt, inner sep=8pt] at ([xshift=10cm, yshift=-11cm]current page.north west) {
    \begin{tabular}{c}
  ...
  \node[fill=primaryblue!8, rounded corners=5pt, inner sep=8pt] at ([xshift=12.5cm, yshift=-11cm]current page.north west) {
    \begin{tabular}{c}
  ...
  \node[fill=primaryblue!8, rounded corners=5pt, inner sep=8pt] at ([xshift=15cm, yshift=-11cm]current page.north west) {
    \begin{tabular}{c}
      {\color{primaryblue}\Large\iconBook}\\[2pt]
      {\color{primaryblue}\large\textbf{5}}\\[-2pt]
      {\color{darktext}\scriptsize Document}\\[-2pt]
      {\color{darktext}\scriptsize Parts}
    \end{tabular}
  };
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[white, opacity=0.3] at ([xshift=-2.75cm, yshift=-8cm]current page.north east) {\fontsize{80}{80}\selectfont\iconShield};
\end{tikzpicture}
