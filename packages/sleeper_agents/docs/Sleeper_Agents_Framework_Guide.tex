...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south west, text width=10cm] at ([xshift=6.5cm, yshift=1.5cm]current page.south west) {
    ...
    {\small\textcolor{gray}{Based on ``Sleeper Agents'' (Hubinger et al., 2024)}}
  };
\end{tikzpicture}
\end{titlepage}
...
{\footnotesize\textcolor{gray}{Version 2.0 | \today}}\\[0.3cm]
{\scriptsize\textcolor{gray}{Based on ``Sleeper Agents'' (Hubinger et al., 2024)}}
\end{center}
\end{minipage}
