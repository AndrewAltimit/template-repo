...
This is exactly what logistic regression learns, proving its optimality under the linear representation assumption. \hfill$\blacksquare$
...
git clone https://github.com/your-org/sleeper-agents-detection.git
cd sleeper-agents-detection
