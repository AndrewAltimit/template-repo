...
\usepackage[
    ...
    pdftitle={Sleeper Agents Detection Framework - Getting Started Guide},
    pdfauthor={Sleeper Agents Detection Team}
]{hyperref}

% Page headers and footers
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Sleeper Agents Detection Framework}}
\fancyhead[R]{\small\textit{Getting Started Guide}}
\fancyfoot[C]{\thepage}
