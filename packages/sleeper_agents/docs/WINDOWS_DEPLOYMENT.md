...
**Important Note**: The Windows PowerShell script `packages/sleeper_agents/scripts/platform/windows/run_evaluation.ps1` contains hardcoded user and group IDs:
