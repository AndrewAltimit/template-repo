...
set "SEARCH_DIR=%CD%"
:find_start_loop
if exist "!SEARCH_DIR!\packages\sleeper_agents\dashboard\start.bat" (
    set "START_SCRIPT=!SEARCH_DIR!\packages\sleeper_agents\dashboard\start.bat"
    goto found_start
)
...
if "!START_SCRIPT!"=="" (
    ...
    echo   cd packages\sleeper_agents\dashboard
    echo   start.bat
    exit /b 1
)
