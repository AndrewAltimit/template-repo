...
\fancyfoot[C]{\textcolor{slatecool}{\footnotesize\textsf{Architectural Qualia \textbar{} Revised July 2026}}}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south east, text width=5.5cm, align=right] at ([xshift=-1.5cm, yshift=3cm]current page.south east) {
    ...
    \textcolor{slatelight}{\textbf{Date}} \textcolor{slatecool}{Revised July 2026}\\[0.3em]
...
\vspace{2em}
\begin{center}
{\color{slatecool}\small\sffamily Living Document. Revised July 2026.}
\end{center}
