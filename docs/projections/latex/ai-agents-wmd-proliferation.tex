...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=5.5cm, yshift=3.5cm]current page.center)}]
    ...
    \draw[labcyan, opacity=0.4, line width=3pt] (0.4, 1.3) -- (1.2, 1.3);
    ...
    \draw[scienceteal, opacity=0.5, line width=3pt] (0.4, 0.1) -- (1.2, 0.1);
    ...
    \draw[barriergold, opacity=0.7, line width=3pt] (0.4, -1.1) -- (1.2, -1.1);
...
\textbf{Version}: & 2.0 \\
\textbf{Related Documents}: & ETRA-2025-ESP-001 (Espionage Operations) \\
& ETRA-2025-AEA-001 (Economic Actors) \\
& ETRA-2025-FIN-001 (Financial Integrity) \\
& ETRA-2025-INS-001 (Institutional Erosion) \\
& ETRA-2025-POL-001 (Political Targeting) \\
\end{tabular}
\end{center}
