...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % Main visualization - Transaction Flow Web
  \begin{scope}[shift={([xshift=-0.5cm, yshift=3.5cm]current page.center)}]

    % SOURCE LAYER (left side) - illicit funds entry points
    \node[mintlight, font=\fontsize{6}{6}\selectfont\sffamily, opacity=0.5] at (-5.5, 2.5) {SOURCE};
    \fill[fraudred, opacity=0.7] (-5, 2) circle (0.35);
    \fill[fraudred, opacity=0.6] (-5.3, 0.5) circle (0.28);
    \fill[fraudred, opacity=0.65] (-4.8, -1) circle (0.32);
    \fill[fraudred, opacity=0.55] (-5.2, -2.3) circle (0.25);

    % LAYERING ZONE (middle) - transaction complexity
    % First layer nodes
    \fill[alertamber, opacity=0.6] (-2.5, 2.3) circle (0.22);
    \fill[alertamber, opacity=0.5] (-2.8, 1) circle (0.18);
    \fill[alertamber, opacity=0.55] (-2.3, -0.3) circle (0.20);
    \fill[alertamber, opacity=0.5] (-2.6, -1.5) circle (0.18);
    \fill[alertamber, opacity=0.6] (-2.4, -2.5) circle (0.22);

    % Second layer nodes (more dispersed)
    \fill[copperrich, opacity=0.5] (-0.5, 2.8) circle (0.16);
    \fill[copperrich, opacity=0.55] (0, 1.5) circle (0.18);
    \fill[copperrich, opacity=0.5] (-0.3, 0.2) circle (0.15);
    \fill[copperrich, opacity=0.6] (0.2, -0.8) circle (0.20);
    \fill[copperrich, opacity=0.5] (-0.2, -2) circle (0.17);
    \fill[copperrich, opacity=0.55] (0.3, -3) circle (0.18);

    % Flow lines from source to first layer (showing dispersion)
    \draw[fraudred, opacity=0.3, line width=1.2pt] (-4.65, 2) -- (-2.72, 2.3);
    \draw[fraudred, opacity=0.25, line width=1pt] (-4.65, 2) -- (-2.98, 1);
    \draw[fraudred, opacity=0.3, line width=1pt] (-5.02, 0.5) -- (-2.52, -0.3);
    \draw[fraudred, opacity=0.25, line width=1pt] (-4.48, -1) -- (-2.78, -1.5);
    \draw[fraudred, opacity=0.3, line width=1.2pt] (-4.95, -2.3) -- (-2.62, -2.5);

    % Flow lines from first to second layer (further dispersion)
    \draw[alertamber, opacity=0.25, line width=0.8pt] (-2.28, 2.3) -- (-0.66, 2.8);
    \draw[alertamber, opacity=0.25, line width=0.8pt] (-2.28, 2.3) -- (-0.18, 1.5);
    \draw[alertamber, opacity=0.2, line width=0.8pt] (-2.58, 1) -- (-0.48, 0.2);
    \draw[alertamber, opacity=0.25, line width=0.8pt] (-2.1, -0.3) -- (0.0, -0.8);
    \draw[alertamber, opacity=0.2, line width=0.8pt] (-2.38, -1.5) -- (-0.37, -2);
    \draw[alertamber, opacity=0.25, line width=0.8pt] (-2.18, -2.5) -- (0.12, -3);

    % CHOKEPOINT (center-right) - the detection/interdiction zone
    \draw[copperrich, opacity=0.2, line width=10pt] (3, 0) circle (1.8cm);
    \draw[copperrich, opacity=0.4, line width=3pt] (3, 0) circle (1.8cm);
    \fill[forestdark, opacity=0.9] (3, 0) circle (1.4cm);
    \fill[copperrich] (3, 0) circle (0.9cm);
    \node[forestdark, font=\fontsize{7}{7}\selectfont\bfseries] at (3, 0.15) {CHOKE};
    \node[forestdark, font=\fontsize{7}{7}\selectfont\bfseries] at (3, -0.2) {POINT};

    % Flow lines converging to chokepoint
    \draw[copperrich, opacity=0.3, line width=1pt] (-0.34, 2.8) .. controls (1, 2) .. (1.6, 0.8);
    \draw[copperrich, opacity=0.35, line width=1.2pt] (0.18, 1.5) -- (1.5, 0.5);
    \draw[copperrich, opacity=0.3, line width=1pt] (-0.15, 0.2) -- (1.6, 0.1);
    \draw[copperrich, opacity=0.35, line width=1.2pt] (0.4, -0.8) -- (1.5, -0.3);
    \draw[copperrich, opacity=0.3, line width=1pt] (-0.03, -2) .. controls (1, -1.5) .. (1.6, -0.7);
    \draw[copperrich, opacity=0.25, line width=0.8pt] (0.48, -3) .. controls (1.5, -2) .. (1.7, -1);

    % EXIT LAYER (right side) - clean money exit
    \fill[mintlight, opacity=0.7] (5.5, 1.2) circle (0.3);
    \fill[mintlight, opacity=0.6] (5.8, -0.3) circle (0.25);
    \fill[mintlight, opacity=0.65] (5.4, -1.5) circle (0.28);
    \node[mintlight, font=\fontsize{6}{6}\selectfont\sffamily, opacity=0.5] at (5.7, 2.2) {EXIT};

    % Exit flow lines (what gets through)
    \draw[mintlight, opacity=0.4, line width=1.5pt] (4.4, 0.5) -- (5.2, 1.1);
    \draw[mintlight, opacity=0.35, line width=1.2pt] (4.4, 0) -- (5.55, -0.3);
    \draw[mintlight, opacity=0.4, line width=1.5pt] (4.4, -0.5) -- (5.12, -1.4);

    % Blocked flows (interdicted) - dashed lines that don't reach exit
    \draw[fraudred, opacity=0.3, line width=1pt, dashed] (4.3, 0.8) -- (4.8, 1.8);
    \draw[fraudred, opacity=0.25, line width=0.8pt, dashed] (4.3, -0.2) -- (4.6, -2.5);
    \fill[fraudred, opacity=0.4] (4.8, 1.8) circle (0.12);
    \fill[fraudred, opacity=0.4] (4.6, -2.5) circle (0.12);
    \node[fraudred, font=\fontsize{5}{5}\selectfont, opacity=0.6] at (5.3, 1.8) {BLOCKED};
    \node[fraudred, font=\fontsize{5}{5}\selectfont, opacity=0.6] at (5.1, -2.5) {BLOCKED};

    % Legend box (bottom right of visualization)
    \fill[black, opacity=0.25, rounded corners=3pt] (3.5, -4.2) rectangle (6.5, -2.8);
    \node[white, opacity=0.5, font=\fontsize{6}{6}\selectfont\sffamily] at (5, -3.0) {TRANSACTION FLOW};
    \fill[fraudred, opacity=0.6] (3.8, -3.4) circle (0.1);
    \node[white, opacity=0.7, font=\fontsize{5}{5}\selectfont, anchor=west] at (4.0, -3.4) {Illicit source};
    \fill[copperrich, opacity=0.6] (3.8, -3.7) circle (0.1);
    \node[white, opacity=0.7, font=\fontsize{5}{5}\selectfont, anchor=west] at (4.0, -3.7) {Layering};
    \fill[mintlight, opacity=0.6] (3.8, -4.0) circle (0.1);
    \node[white, opacity=0.7, font=\fontsize{5}{5}\selectfont, anchor=west] at (4.0, -4.0) {Clean exit};
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Visualization: Defense-in-Depth Layers (AML control framework)
  \begin{scope}[shift={(3cm, -7.2cm)}]
    % Outer layer - Transaction Monitoring (widest, most porous)
    \draw[mintlight, opacity=0.15, line width=12pt] (3, 0) ellipse (5cm and 2cm);
    \draw[mintlight, opacity=0.4, line width=1.5pt, dashed] (3, 0) ellipse (5cm and 2cm);
    \node[mintlight, opacity=0.6, font=\fontsize{6}{6}\selectfont\sffamily] at (3, 2.3) {TRANSACTION MONITORING};

    % Middle layer - KYC/KYB Verification
    \draw[moneygreen, opacity=0.2, line width=10pt] (3, 0) ellipse (3.5cm and 1.4cm);
    \draw[moneygreen, opacity=0.5, line width=1.5pt] (3, 0) ellipse (3.5cm and 1.4cm);
    \node[moneygreen, opacity=0.7, font=\fontsize{6}{6}\selectfont\sffamily] at (3, 1.65) {KYC / KYB VERIFICATION};

    % Inner layer - Endpoint Control (chokepoints)
    \draw[copperrich, opacity=0.25, line width=8pt] (3, 0) ellipse (2cm and 0.8cm);
    \draw[copperrich, opacity=0.7, line width=2pt] (3, 0) ellipse (2cm and 0.8cm);
    \node[copperrich, opacity=0.9, font=\fontsize{6}{6}\selectfont\sffamily\bfseries] at (3, 1.05) {ENDPOINT CONTROL};

    % Core - Protected financial system
    \fill[emeralddeep, opacity=0.8] (3, 0) ellipse (0.8cm and 0.35cm);
    \node[white, font=\fontsize{5}{5}\selectfont\bfseries] at (3, 0) {SYSTEM};

    % Attack arrows (showing penetration attempts)
    \draw[fraudred, opacity=0.5, line width=1.5pt, -Stealth] (-0.5, 1.2) -- (0.8, 0.6);
    \draw[fraudred, opacity=0.4, line width=1pt, -Stealth] (-0.3, -0.8) -- (1.0, -0.4);
    \draw[fraudred, opacity=0.5, line width=1.5pt, -Stealth] (7, 0.9) -- (5.5, 0.5);
    \node[fraudred, opacity=0.6, font=\fontsize{5}{5}\selectfont] at (-0.8, 0.2) {THREATS};
  \end{scope}

  % Legend
  \node[white, opacity=0.5, font=\fontsize{7}{7}\selectfont, anchor=west] at (10.5cm, -5.7cm) {DEFENSE LAYERS};
  \node[anchor=west] at (10.5cm, -6.4cm) {
    \begin{tikzpicture}
      \draw[mintlight, opacity=0.5, line width=2pt, dashed] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Monitoring (porous)};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.0cm) {
    \begin{tikzpicture}
      \draw[moneygreen, opacity=0.6, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Identity verification};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.6cm) {
    \begin{tikzpicture}
      \draw[copperrich, opacity=0.8, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Chokepoints (robust)};
    \end{tikzpicture}
  };
...
\begin{itemize}
  ...
  \item \textbf{Fraud as upstream driver}: UK Finance's 2025 Annual Fraud Report documents \textbf{>\pounds1.1 billion} in fraud losses in 2024
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Visualization: Speed Asymmetry - Transaction velocity comparison
  \begin{scope}[shift={(3cm, -7cm)}]
    % Background box
    \fill[black, opacity=0.2, rounded corners=4pt] (-0.5, -1.8) rectangle (6.5, 2.2);

    % Title
    \node[white, opacity=0.6, font=\fontsize{7}{7}\selectfont\sffamily] at (3, 1.9) {SPEED ASYMMETRY};

    % Human investigation timeline (slow)
    \draw[ledgergray, opacity=0.4, line width=6pt] (0, 1) -- (6, 1);
    \draw[ledgergray, opacity=0.7, line width=1pt] (0, 1) -- (6, 1);
    \node[ledgergray, opacity=0.8, font=\fontsize{5}{5}\selectfont, anchor=east] at (-0.2, 1) {INVESTIGATION};
    % Milestones on investigation timeline
    \fill[ledgergray, opacity=0.6] (1.5, 1) circle (0.12);
    \node[white, opacity=0.5, font=\fontsize{4}{4}\selectfont] at (1.5, 0.6) {Alert};
    \fill[ledgergray, opacity=0.6] (4, 1) circle (0.12);
    \node[white, opacity=0.5, font=\fontsize{4}{4}\selectfont] at (4, 0.6) {Review};
    \fill[ledgergray, opacity=0.6] (6, 1) circle (0.12);
    \node[white, opacity=0.5, font=\fontsize{4}{4}\selectfont] at (6, 0.6) {Action};

    % Agent operation timeline (fast)
    \draw[copperrich, opacity=0.3, line width=6pt] (0, -0.5) -- (6, -0.5);
    \draw[copperrich, opacity=0.8, line width=1.5pt] (0, -0.5) -- (6, -0.5);
    \node[copperrich, opacity=0.9, font=\fontsize{5}{5}\selectfont, anchor=east] at (-0.2, -0.5) {AGENT OPS};
    % Many rapid milestones
    \foreach \x in {0.3, 0.6, 0.9, 1.2, 1.5, 1.8} {
      \fill[copperrich, opacity=0.7] (\x, -0.5) circle (0.08);
    }
    \node[copperrich, opacity=0.7, font=\fontsize{4}{4}\selectfont] at (1.05, -0.9) {ms timescale};

    % "Funds exited" marker
    \draw[fraudred, opacity=0.6, line width=1.5pt, dashed] (2, -1.3) -- (2, 1.5);
    \node[fraudred, opacity=0.8, font=\fontsize{5}{5}\selectfont, rotate=90, anchor=south] at (2.3, 0.1) {FUNDS EXITED};

    % Time scale
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (0, -1.5) {Hour 0};
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (3, -1.5) {Hour 24};
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (6, -1.5) {Hour 48};
  \end{scope}

  % Legend
  \node[white, opacity=0.5, font=\fontsize{7}{7}\selectfont, anchor=west] at (10.5cm, -5.7cm) {DETECTION CHALLENGE};
  \node[anchor=west] at (10.5cm, -6.4cm) {
    \begin{tikzpicture}
      \draw[ledgergray, opacity=0.6, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Human timescale};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.0cm) {
    \begin{tikzpicture}
      \draw[copperrich, opacity=0.8, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Agent timescale};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.6cm) {
    \begin{tikzpicture}
      \draw[fraudred, opacity=0.6, line width=1pt, dashed] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Interdiction window};
    \end{tikzpicture}
  };
...
\textbf{Detection challenge}: The communications are individually legitimate---professional networking, industry discussion. Only the aggregate pattern reveals the manipulation.
\end{warnbox}
...
\textbf{Agents excel at paperwork [E]}: Generative AI is unusually good at creating plausible documentation at scale---vendor qualification packages, financial statements, reference letters, technical specifications.

\textbf{Defensive implication}: Procurement integrity requires \textbf{cryptographic provenance} (digital signatures, verifiable credentials, blockchain attestation), not just ``did a human read the PDF.''
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Visualization: The Regulatory Gap - Diverging lines
  \begin{scope}[shift={(3cm, -7cm)}]
    % Background box
    \fill[black, opacity=0.2, rounded corners=4pt] (-0.5, -1.5) rectangle (6.5, 2);

    % Title
    \node[white, opacity=0.6, font=\fontsize{7}{7}\selectfont\sffamily] at (3, 1.7) {THE GOVERNANCE GAP};

    % Axes
    \draw[white, opacity=0.3, line width=0.8pt, -Stealth] (0, -1) -- (6.2, -1);
    \draw[white, opacity=0.3, line width=0.8pt, -Stealth] (0, -1) -- (0, 1.5);
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (6.2, -1.3) {TIME};

    % Starting point
    \fill[white] (0.5, -0.5) circle (0.08);

    % Agent capability line (steep rise - green/mint)
    \draw[mintlight, line width=2.5pt] (0.5, -0.5) .. controls (2, 0) and (4, 0.8) .. (5.5, 1.3);
    \node[mintlight, opacity=0.9, font=\fontsize{6}{6}\selectfont\sffamily, anchor=south west] at (5.6, 1.2) {CAPABILITY};

    % Regulatory response line (slow rise - amber)
    \draw[alertamber, line width=2.5pt] (0.5, -0.5) .. controls (2, -0.3) and (4, 0) .. (5.5, 0.2);
    \node[alertamber, opacity=0.9, font=\fontsize{6}{6}\selectfont\sffamily, anchor=north west] at (5.6, 0.2) {REGULATION};

    % Gap fill
    \fill[fraudred, opacity=0.15]
      (0.5, -0.5) .. controls (2, 0) and (4, 0.8) .. (5.5, 1.3)
      -- (5.5, 0.2) .. controls (4, 0) and (2, -0.3) .. (0.5, -0.5);

    % Gap arrow
    \draw[copperrich, line width=1.5pt, <->] (4.5, 0.15) -- (4.5, 0.95);
    \node[copperrich, font=\fontsize{5}{5}\selectfont\bfseries, anchor=west] at (4.7, 0.55) {GAP};

    % Year markers
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (0.5, -1.3) {2024};
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (3, -1.3) {2027};
    \node[white, opacity=0.4, font=\fontsize{5}{5}\selectfont] at (5.5, -1.3) {2030};
  \end{scope}

  % Legend
  \node[white, opacity=0.5, font=\fontsize{7}{7}\selectfont, anchor=west] at (10.5cm, -5.7cm) {POLICY CHALLENGE};
  \node[anchor=west] at (10.5cm, -6.4cm) {
    \begin{tikzpicture}
      \draw[mintlight, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Agent capability};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.0cm) {
    \begin{tikzpicture}
      \draw[alertamber, line width=2pt] (0,0) -- (0.3, 0);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Regulatory response};
    \end{tikzpicture}
  };
  \node[anchor=west] at (10.5cm, -7.6cm) {
    \begin{tikzpicture}
      \fill[fraudred, opacity=0.3] (0,-0.1) rectangle (0.3, 0.1);
      \node[white, opacity=0.7, font=\fontsize{7}{7}\selectfont, anchor=west] at (0.4, 0) {Vulnerability window};
    \end{tikzpicture}
  };
...
\textbf{Limitations}: Applies only to agents on regulated platforms; open-source agents remain uncontrolled.
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % UNIQUE VISUALIZATION: Policy Framework Pillars
  % Four pillars representing the recommendation categories
  \begin{scope}[shift={(5.5cm, -7cm)}]
    % Foundation bar
    \fill[emeralddeep, opacity=0.8] (-0.5, -1.5) rectangle (10.5, -1.2);
    \node[white, font=\fontsize{6}{6}\selectfont\sffamily] at (5, -1.35) {GOVERNANCE FRAMEWORK};

    % Pillar dimensions: width=2cm, gap=0.5cm, total=4*2+3*0.5=9.5cm centered at x=5
    % Pillars at: 0.25, 2.75, 5.25, 7.75

    % Pillar 1 - Technical (tallest)
    \fill[moneygreen, opacity=0.9] (0.25, -1.1) rectangle (2.25, 1.8);
    \node[white, font=\fontsize{6}{6}\selectfont\bfseries] at (1.25, 0.35) {TECHNICAL};
    \fill[copperrich] (0.25, 1.8) rectangle (2.25, 2.0);

    % Pillar 2 - Legal (medium-tall)
    \fill[moneygreen, opacity=0.75] (2.75, -1.1) rectangle (4.75, 1.3);
    \node[white, font=\fontsize{6}{6}\selectfont\bfseries] at (3.75, 0.1) {LEGAL};
    \fill[copperrich] (2.75, 1.3) rectangle (4.75, 1.5);

    % Pillar 3 - Operational (medium)
    \fill[moneygreen, opacity=0.6] (5.25, -1.1) rectangle (7.25, 0.8);
    \node[white, font=\fontsize{5}{5}\selectfont\bfseries] at (6.25, -0.15) {OPS};
    \fill[copperrich] (5.25, 0.8) rectangle (7.25, 1.0);

    % Pillar 4 - International (shortest, still building)
    \fill[moneygreen, opacity=0.45] (7.75, -1.1) rectangle (9.75, 0.3);
    \node[white, font=\fontsize{5}{5}\selectfont\bfseries] at (8.75, -0.4) {INT'L};
    \fill[copperrich] (7.75, 0.3) rectangle (9.75, 0.5);
    % Building indicator (dashed outline showing growth potential)
    \draw[copperrich, dashed, opacity=0.6, line width=1pt] (7.75, 0.5) rectangle (9.75, 1.3);
  \end{scope}
...
\begin{itemize}
  \item \textbf{Evidence of agent-facilitated laundering at scale}: Documented case of agent system laundering >\$10M
  \item \textbf{Detection system failure}: Major financial institution breach via agent-based attack
  \item \textbf{Regulatory fragmentation}: Major jurisdiction explicitly permitting unrestricted agent financial activity
\end{itemize}

\subsection{Factors That Would Decrease Concern}

\begin{itemize}
  \item \textbf{Effective agent identification systems}: Robust technical standards for agent authentication
  \item \textbf{Detection parity achieved}: Counter-agent systems demonstrably effective
  \item \textbf{International coordination success}: FATF agent guidance widely implemented
  \item \textbf{Hardware-level enforcement}: TPM-style attestation for AI workloads accessing financial APIs
\end{itemize}
