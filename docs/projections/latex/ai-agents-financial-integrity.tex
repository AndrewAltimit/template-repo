...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=3.5cm]current page.center)}]
    ...
    \node[white, font=\fontsize{9}{9}\selectfont\sffamily\bfseries, opacity=0.9] at (-5.5, 3.2) {ILLICIT};
    \node[white, font=\fontsize{9}{9}\selectfont\sffamily\bfseries, opacity=0.9] at (-5.5, 2.7) {FUNDS};
    \fill[fraudred, opacity=0.8] (-5, 2) circle (0.35);
    \fill[fraudred, opacity=0.7] (-5.3, 0.5) circle (0.28);
    \fill[fraudred, opacity=0.75] (-4.8, -1) circle (0.32);
    \fill[fraudred, opacity=0.65] (-5.2, -2.3) circle (0.25);

    % LAYERING ZONE (middle) - transaction complexity
    % First layer nodes
    \fill[alertamber, opacity=0.7] (-2.5, 2.3) circle (0.22);
    \fill[alertamber, opacity=0.6] (-2.8, 1) circle (0.18);
    \fill[alertamber, opacity=0.65] (-2.3, -0.3) circle (0.20);
    \fill[alertamber, opacity=0.6] (-2.6, -1.5) circle (0.18);
    \fill[alertamber, opacity=0.7] (-2.4, -2.5) circle (0.22);

    % Second layer nodes (more dispersed)
    \fill[copperrich, opacity=0.6] (-0.5, 2.8) circle (0.16);
    \fill[copperrich, opacity=0.65] (0, 1.5) circle (0.18);
    \fill[copperrich, opacity=0.6] (-0.3, 0.2) circle (0.15);
    \fill[copperrich, opacity=0.7] (0.2, -0.8) circle (0.20);
    \fill[copperrich, opacity=0.6] (-0.2, -2) circle (0.17);
    \fill[copperrich, opacity=0.65] (0.3, -3) circle (0.18);

    % Flow lines from source to first layer (showing dispersion)
    \draw[fraudred, opacity=0.4, line width=1.2pt] (-4.65, 2) -- (-2.72, 2.3);
    \draw[fraudred, opacity=0.35, line width=1pt] (-4.65, 2) -- (-2.98, 1);
    \draw[fraudred, opacity=0.4, line width=1pt] (-5.02, 0.5) -- (-2.52, -0.3);
    \draw[fraudred, opacity=0.35, line width=1pt] (-4.48, -1) -- (-2.78, -1.5);
    \draw[fraudred, opacity=0.4, line width=1.2pt] (-4.95, -2.3) -- (-2.62, -2.5);

    % Flow lines from first to second layer (further dispersion)
    \draw[alertamber, opacity=0.35, line width=0.8pt] (-2.28, 2.3) -- (-0.66, 2.8);
    \draw[alertamber, opacity=0.35, line width=0.8pt] (-2.28, 2.3) -- (-0.18, 1.5);
    \draw[alertamber, opacity=0.3, line width=0.8pt] (-2.58, 1) -- (-0.48, 0.2);
    \draw[alertamber, opacity=0.35, line width=0.8pt] (-2.1, -0.3) -- (0.0, -0.8);
    \draw[alertamber, opacity=0.3, line width=0.8pt] (-2.38, -1.5) -- (-0.37, -2);
    \draw[alertamber, opacity=0.35, line width=0.8pt] (-2.18, -2.5) -- (0.12, -3);

    % CHOKEPOINT (center-right) - the detection/interdiction zone
    \draw[copperrich, opacity=0.25, line width=10pt] (3, 0) circle (1.8cm);
    \draw[copperrich, opacity=0.5, line width=3pt] (3, 0) circle (1.8cm);
    \fill[forestdark, opacity=0.95] (3, 0) circle (1.4cm);
    \fill[copperrich] (3, 0) circle (0.9cm);
    \node[forestdark, font=\fontsize{9}{9}\selectfont\bfseries] at (3, 0.15) {CHOKE};
    \node[forestdark, font=\fontsize{9}{9}\selectfont\bfseries] at (3, -0.25) {POINT};

    % Flow lines converging to chokepoint
    \draw[copperrich, opacity=0.4, line width=1pt] (-0.34, 2.8) .. controls (1, 2) .. (1.6, 0.8);
    \draw[copperrich, opacity=0.45, line width=1.2pt] (0.18, 1.5) -- (1.5, 0.5);
    \draw[copperrich, opacity=0.4, line width=1pt] (-0.15, 0.2) -- (1.6, 0.1);
    \draw[copperrich, opacity=0.45, line width=1.2pt] (0.4, -0.8) -- (1.5, -0.3);
    \draw[copperrich, opacity=0.4, line width=1pt] (-0.03, -2) .. controls (1, -1.5) .. (1.6, -0.7);
    \draw[copperrich, opacity=0.35, line width=0.8pt] (0.48, -3) .. controls (1.5, -2) .. (1.7, -1);

    % EXIT LAYER (right side) - clean money exit
    \fill[mintlight, opacity=0.8] (5.5, 1.2) circle (0.3);
    \fill[mintlight, opacity=0.7] (5.8, -0.3) circle (0.25);
    \fill[mintlight, opacity=0.75] (5.4, -1.5) circle (0.28);
    \node[white, font=\fontsize{9}{9}\selectfont\sffamily\bfseries, opacity=0.9] at (5.7, 2.7) {CLEAN};
    \node[white, font=\fontsize{9}{9}\selectfont\sffamily\bfseries, opacity=0.9] at (5.7, 2.2) {EXIT};

    % Exit flow lines (what gets through)
    \draw[mintlight, opacity=0.5, line width=1.5pt] (4.4, 0.5) -- (5.2, 1.1);
    \draw[mintlight, opacity=0.45, line width=1.2pt] (4.4, 0) -- (5.55, -0.3);
    \draw[mintlight, opacity=0.5, line width=1.5pt] (4.4, -0.5) -- (5.12, -1.4);

    % Legend box (bottom center - lowered to avoid overlap)
    \fill[black, opacity=0.35, rounded corners=4pt] (-1.5, -5.5) rectangle (3.5, -4.0);
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (1, -4.25) {MONEY LAUNDERING FLOW};
    \fill[fraudred, opacity=0.8] (-1.1, -4.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.85, -4.7) {Illicit funds};
    \fill[alertamber, opacity=0.8] (-1.1, -5.1) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.85, -5.1) {Layering};
    \fill[mintlight, opacity=0.8] (1.8, -4.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (2.05, -4.7) {Clean exit};
    \fill[copperrich] (1.8, -5.1) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (2.05, -5.1) {Detection};
