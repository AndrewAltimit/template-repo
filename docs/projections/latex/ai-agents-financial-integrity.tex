...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=3.5cm]current page.center)}]
    ...
    \fill[black, opacity=0.35, rounded corners=4pt] (-1.5, -4.5) rectangle (3.5, -3.0);
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (1, -3.25) {MONEY LAUNDERING FLOW};
    \fill[fraudred, opacity=0.8] (-1.1, -3.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.85, -3.7) {Illicit funds};
    \fill[copperrich, opacity=0.8] (-1.1, -4.1) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.85, -4.1) {Layering};
    \fill[mintlight, opacity=0.8] (1.8, -3.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (2.05, -3.7) {Clean exit};
    \fill[copperrich] (1.8, -4.1) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (2.05, -4.1) {Detection};
