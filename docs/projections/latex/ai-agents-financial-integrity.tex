...
\textbf{Probability assessment [E]}: 35\% as primary outcome through 2028 \textit{(adjusted down from 40\% in v1.0; the 162\% YoY increase in illicit crypto volume and emergence of DPRK-linked agent-assisted operations suggest the threat is evolving faster than the ``incremental'' framing implies)}
