...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(0.5\paperwidth, -7cm)}]
    ...
    \node[white, font=\fontsize{9}{9}\selectfont\bfseries] at (-3.6, 0.3) {TECHNICAL};

    % Pillar 2 - Legal (medium-tall)
    \fill[moneygreen, opacity=0.9] (-2.1, -1.2) rectangle (-0.3, 1.3);
    \node[white, font=\fontsize{9}{9}\selectfont\bfseries] at (-1.2, 0.05) {LEGAL};

    % Pillar 3 - Operational (medium)
    \fill[moneygreen, opacity=0.9] (0.3, -1.2) rectangle (2.1, 0.8);
    \node[white, font=\fontsize{8}{8}\selectfont\bfseries] at (1.2, -0.2) {OPERATIONAL};

    % Pillar 4 - International (shortest)
    \fill[moneygreen, opacity=0.9] (2.7, -1.2) rectangle (4.5, 0.3);
    \node[white, font=\fontsize{8}{8}\selectfont\bfseries] at (3.6, -0.45) {INT'L};
