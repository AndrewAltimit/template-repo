...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=3.5cm]current page.center)}]
    ...
    % Legend box (bottom center - simplified, chokepoint already labeled)
    \fill[black, opacity=0.35, rounded corners=4pt] (-1.0, -5.2) rectangle (3.0, -4.0);
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (1, -4.25) {MONEY LAUNDERING FLOW};
    \fill[fraudred, opacity=0.8] (-0.6, -4.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.35, -4.7) {Illicit funds};
    \fill[copperrich, opacity=0.8] (-0.6, -4.95) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (-0.35, -4.95) {Layering};
    \fill[mintlight, opacity=0.8] (1.5, -4.7) circle (0.12);
    \node[white, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (1.75, -4.7) {Clean exit};
