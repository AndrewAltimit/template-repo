...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=3.5cm]current page.center)}]
    ...
    \draw[copperrich, opacity=0.15, line width=16pt] (0,0) circle (4.8cm);
    \draw[copperrich, opacity=0.50, line width=2pt] (0,0) circle (4.8cm);
    ...
    % MIDDLE RING - AML / KYC
    \draw[moneygreen, opacity=0.10, line width=12pt] (0,0) circle (3.2cm);
    \draw[moneygreen, opacity=0.45, line width=1.5pt] (0,0) circle (3.2cm);
    \node[flowgrid, opacity=0.4, font=\fontsize{7}{7}\selectfont\sffamily] at (270:3.8cm) {AML / KYC};

    % INNER RING - Cross-Institution
    \draw[complianceblue, opacity=0.10, line width=8pt] (0,0) circle (2.0cm);
    \draw[complianceblue, opacity=0.40, line width=1.5pt] (0,0) circle (2.0cm);
    \node[flowgrid, opacity=0.4, font=\fontsize{7}{7}\selectfont\sffamily] at (270:2.5cm) {CROSS-INSTITUTION};

    % CENTRAL CORE - KYA Chokepoint
