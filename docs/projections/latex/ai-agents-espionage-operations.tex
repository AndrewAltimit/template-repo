...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=1.5cm]current page.center)}]
    % Outer cipher ring - rotating letters
    \draw[chromesilver, opacity=0.2, line width=8pt] (0,0) circle (5cm);
    \draw[signalred, opacity=0.4, line width=2pt] (0,0) circle (5cm);
    \foreach \i/\letter in {0/A, 15/B, 30/C, 45/D, 60/E, 75/F, 90/G, 105/H, 120/I, 135/J, 150/K, 165/L, 180/M, 195/N, 210/O, 225/P, 240/Q, 255/R, 270/S, 285/T, 300/U, 315/V, 330/W, 345/X} {
      \node[chromesilver, opacity=0.5, font=\fontsize{8}{8}\selectfont\bfseries] at (\i:5.5cm) {\letter};
    }

    % Middle cipher ring - offset rotation with numbers
    \draw[signalcyan, opacity=0.15, line width=6pt] (0,0) circle (3.8cm);
    \draw[signalcyan, opacity=0.4, line width=1.5pt] (0,0) circle (3.8cm);
    \foreach \i/\num in {7/0, 37/1, 67/2, 97/3, 127/4, 157/5, 187/6, 217/7, 247/8, 277/9, 307/X, 337/Y} {
      \node[signalcyan, opacity=0.6, font=\fontsize{7}{7}\selectfont\bfseries] at (\i:4.2cm) {\num};
    }

    % Inner cipher ring - symbols
    \draw[ciphergold, opacity=0.2, line width=5pt] (0,0) circle (2.6cm);
    \draw[ciphergold, opacity=0.5, line width=1.5pt] (0,0) circle (2.6cm);
    \foreach \i in {0,30,...,330} {
      \fill[ciphergold, opacity=0.4] (\i:2.9cm) circle (0.08);
    }
    ...
    % Central core - decoded signal
    \fill[midnightblue, opacity=0.8] (0,0) circle (1.6cm);
    \fill[shadownavy, opacity=0.9] (0,0) circle (1.2cm);
    \fill[signalred] (0,0) circle (0.7cm);
    \node[white, font=\fontsize{7}{7}\selectfont\bfseries] at (0,0.12) {SIGNAL};
    \node[white, font=\fontsize{7}{7}\selectfont\bfseries] at (0,-0.15) {DECODED};
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \node[signalred, font=\fontsize{10}{10}\selectfont\sffamily] at (0.5\paperwidth, -1.2cm) {PART I};
  ...
  % Encryption key / cipher visualization
  \begin{scope}[shift={(3cm, -7.5cm)}]
    % Key outline (stylized)
    \draw[chromesilver, opacity=0.3, line width=3pt] (0,0) -- (3,0);
    \draw[chromesilver, opacity=0.3, line width=3pt] (3,0) circle (0.8);
    % Key teeth pattern
    \foreach \x in {0.5,1.0,1.5,2.0,2.5} {
      \fill[signalred, opacity=0.6] (\x,-0.2) rectangle ({\x+0.15},0.2);
    }
    % Key ring
    \draw[signalred, opacity=0.8, line width=2pt] (3,0) circle (0.6);
    \fill[signalred, opacity=0.3] (3,0) circle (0.4);

    % Binary/cipher stream below
    \node[chromesilver, opacity=0.4, font=\fontsize{6}{6}\selectfont\ttfamily] at (2,-1.2) {01101001 01101110 01110100 01100101 01101100};
  \end{scope}

  % Cost comparison (right side - simplified)
  \begin{scope}[shift={(10cm, -7.5cm)}]
    \draw[chromesilver, opacity=0.4, line width=1pt, -Stealth] (0,0) -- (4.5,0);
    \draw[chromesilver, opacity=0.4, line width=1pt, -Stealth] (0,0) -- (0,2);
    \node[chromesilver, opacity=0.6, font=\fontsize{6}{6}\selectfont] at (4.8,0) {SCALE};
    \node[chromesilver, opacity=0.6, font=\fontsize{6}{6}\selectfont] at (0,2.3) {COST};

    % Traditional curve (steep)
    \draw[coldsteel, opacity=0.7, line width=2pt] (0.2,0.2) .. controls (1,0.8) and (2.5,1.5) .. (4,2);
    \node[coldsteel, opacity=0.8, font=\fontsize{6}{6}\selectfont] at (4.3,1.7) {Trad.};

    % AI-enabled curve (flat)
    \draw[signalred, opacity=0.9, line width=2pt] (0.2,0.5) .. controls (1,0.6) and (2.5,0.7) .. (4,0.75);
    \node[signalred, font=\fontsize{6}{6}\selectfont] at (4.3,0.5) {AI};

    % Current marker
    \fill[signalred] (2.8, 0.68) circle (0.15);
    \node[shadowdark, font=\fontsize{5}{5}\selectfont\bfseries] at (2.8, 0.68) {N};
  \end{scope}

  % Bottom accent
  \fill[signalred] (2cm, -9.2cm) rectangle (\paperwidth-2cm, -9.3cm);
\end{tikzpicture}
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Part label and title
  \node[signalred, font=\fontsize{10}{10}\selectfont\sffamily] at (0.5\paperwidth, -1.2cm) {PART II};
  ...
  % Signal intercept visualization - waveform analysis
  \begin{scope}[shift={(3cm, -7cm)}]
    % Frequency spectrum background
    \fill[midnightblue, opacity=0.5] (0,-0.8) rectangle (5.5,1.2);
    \draw[chromesilver, opacity=0.3, line width=0.5pt] (0,-0.8) rectangle (5.5,1.2);

    % Signal waveforms (intercepted)
    \draw[signalred, opacity=0.8, line width=1.5pt]
    ...
    \draw[signalcyan, opacity=0.6, line width=1pt]
    ...
    % Intercept marker
    \draw[ciphergold, opacity=0.9, line width=1.5pt, dashed] (2.9,-0.8) -- (2.9,1.2);
    \node[ciphergold, font=\fontsize{6}{6}\selectfont\bfseries] at (2.9,1.4) {INTERCEPT};
  \end{scope}

  % Threat radar (right side - simplified)
  \begin{scope}[shift={(11cm, -7cm)}]
    % Background rings
    \foreach \r in {0.5, 1.0, 1.5} {
      \draw[chromesilver, opacity=0.15, line width=0.5pt] (0,0) circle (\r);
    }

    % Axis lines
    \foreach \a in {0,60,120,180,240,300} {
      \draw[chromesilver, opacity=0.2, line width=0.5pt] (0,0) -- (\a:1.6);
    }

    % Labels
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (90:1.9) {SCALE};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (30:1.9) {STEALTH};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (330:1.9) {PERSIST};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (270:1.9) {ATTRIB};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (210:1.9) {COST};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont\bfseries] at (150:1.9) {ADAPT};

    % Traditional threat
    \fill[coldsteel, opacity=0.25]
      (90:0.5) -- (30:0.6) -- (330:0.9) -- (270:0.8) -- (210:0.4) -- (150:0.6) -- cycle;
    \draw[coldsteel, opacity=0.5, line width=1pt]
      (90:0.5) -- (30:0.6) -- (330:0.9) -- (270:0.8) -- (210:0.4) -- (150:0.6) -- cycle;

    % AI-enabled threat
    \fill[signalred, opacity=0.3]
      (90:1.4) -- (30:1.2) -- (330:1.1) -- (270:0.5) -- (210:1.3) -- (150:1.25) -- cycle;
    \draw[signalred, opacity=0.8, line width=1.5pt]
      (90:1.4) -- (30:1.2) -- (330:1.1) -- (270:0.5) -- (210:1.3) -- (150:1.25) -- cycle;

    % Center
    \fill[signalred] (0,0) circle (0.06);
  \end{scope}
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Part label and title
  \node[signalred, font=\fontsize{10}{10}\selectfont\sffamily] at (0.5\paperwidth, -1.2cm) {PART III};
  ...
  \begin{scope}[shift={(4cm, -7cm)}]
    ...
    \draw[signalred, opacity=0.5, line width=1.5pt, dashed] (-1.5,0.8) -- (0,0.8);
    \draw[signalred, opacity=0.5, line width=1.5pt, dashed] (-1.5,0) -- (0,0);
    \draw[signalred, opacity=0.5, line width=1.5pt, dashed] (-1.5,-0.8) -- (0,-0.8);
    % Block indicators
    \node[signalred, font=\fontsize{8}{8}\selectfont\bfseries] at (-0.3,0.8) {X};
    \node[signalred, font=\fontsize{8}{8}\selectfont\bfseries] at (-0.3,0) {X};
    \node[signalred, font=\fontsize{8}{8}\selectfont\bfseries] at (-0.3,-0.8) {X};
    % Protected zone (right side)
    \fill[steelblue, opacity=0.2] (4.4,-1.3) rectangle (6,1.3);
    \node[chromesilver, font=\fontsize{7}{7}\selectfont\bfseries] at (5.2,0) {SECURE};
  \end{scope}

  % Shield icon (right side)
  \begin{scope}[shift={(12cm, -7cm)}]
    % Shield outline
    \draw[interceptgreen, opacity=0.8, line width=2pt] (0,1) -- (1.2,0.3) -- (1.2,-0.8) -- (0,-1.3) -- (-1.2,-0.8) -- (-1.2,0.3) -- cycle;
    \fill[interceptgreen, opacity=0.15] (0,0.8) -- (1,0.2) -- (1,-0.6) -- (0,-1.1) -- (-1,-0.6) -- (-1,0.2) -- cycle;
    % Lock symbol in center
    \draw[chromesilver, opacity=0.8, line width=1.5pt] (-0.25,-0.3) -- (-0.25,0.1) arc (180:0:0.25) -- (0.25,-0.3);
    \fill[chromesilver, opacity=0.6] (-0.35,-0.3) rectangle (0.35,-0.7);
    \fill[shadowdark] (0,-0.45) circle (0.08);
  \end{scope}

  % Legend
  \node[chromesilver, opacity=0.7, font=\fontsize{8}{8}\selectfont\bfseries, anchor=west] at (10cm, -5.2cm) {DEFENSE-IN-DEPTH};
  \node[interceptgreen, opacity=0.85, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -5.8cm) {Multi-layer controls};
  \node[chromesilver, opacity=0.85, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -6.4cm) {Identity verification};
  \node[chromesilver, opacity=0.85, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -7cm) {AI supply chain governance};
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Part label and title
  \node[signalred, font=\fontsize{10}{10}\selectfont\sffamily] at (0.5\paperwidth, -1.2cm) {PART IV};
  ...
  \begin{scope}[shift={(3cm, -7.5cm)}]
    ...
    % Current marker
    \fill[signalred] (0,0) circle (0.22);
    \node[signalred, font=\fontsize{7}{7}\selectfont\bfseries] at (0,0.6) {NOW};

    % Transition zone (offense advantage)
    \fill[signalred, opacity=0.25] (1.5,-0.35) rectangle (7.5,0.35);
    \draw[signalred, opacity=0.6, line width=1pt] (1.5,-0.35) rectangle (7.5,0.35);
    \node[signalred, font=\fontsize{7}{7}\selectfont\bfseries] at (4.5,0.7) {OFFENSE ADVANTAGE};
