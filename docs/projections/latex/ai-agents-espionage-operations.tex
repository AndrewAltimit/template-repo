...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-0.5cm, yshift=1.5cm]current page.center)}]
    ...
    % Cross-connections (showing complexity) - increased opacity for visibility
    \draw[white, opacity=0.18, line width=0.7pt] (30:4cm) -- (165:4cm);
    \draw[white, opacity=0.18, line width=0.7pt] (75:4cm) -- (255:4cm);
    \draw[white, opacity=0.18, line width=0.7pt] (120:4cm) -- (300:4cm);
    \draw[white, opacity=0.18, line width=0.7pt] (210:4cm) -- (345:4cm);
  \end{scope}
...
\vspace*{0.5cm}
\begin{center}
{\color{instdark}\Large\bfseries Decision Summary}
\end{center}
\vspace{0.3cm}
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(3cm, -8.5cm)}]
    ...
    \draw[instaccent, opacity=0.8, line width=2.5pt] (0.3,0.3) .. controls (1.5,1.2) and (3,2.2) .. (5.5,2.8);
    \node[instaccent, opacity=0.9, font=\fontsize{7}{7}\selectfont\itshape] at (5.8, 2.5) {Traditional};

    % AI-enabled cost curve (flat)
    \draw[instgold, opacity=0.9, line width=2.5pt] (0.3,0.8) .. controls (1.5,0.9) and (3,1.0) .. (5.5,1.1);
    \node[instgold, font=\fontsize{7}{7}\selectfont\itshape] at (5.8, 0.8) {AI-Enabled};

    % Current marker - larger for visibility
    \fill[instgold] (3.8, 1.0) circle (0.22);
    \node[instdark, font=\fontsize{6}{6}\selectfont\bfseries] at (3.8, 1.0) {NOW};
  \end{scope}
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(5cm, -6.4cm)}]
    ...
    % Labels - increased font size and opacity for readability
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (90:2.5) {SCALE};
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (30:2.5) {STEALTH};
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (330:2.5) {PERSIST};
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (270:2.5) {ATTRIB};
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (210:2.5) {COST};
    \node[white, opacity=0.8, font=\fontsize{7}{7}\selectfont\bfseries] at (150:2.5) {ADAPT};

    % Traditional threat (dimmer, smaller) - increased opacity
    \fill[instaccent, opacity=0.3]
      (90:0.75) -- (30:0.9) -- (330:1.25) -- (270:1.15) -- (210:0.6) -- (150:0.85) -- cycle;
    \draw[instaccent, opacity=0.6, line width=1.2pt]
      (90:0.75) -- (30:0.9) -- (330:1.25) -- (270:1.15) -- (210:0.6) -- (150:0.85) -- cycle;

    % AI-enabled threat (brighter, larger) - increased opacity
    \fill[instgold, opacity=0.35]
      (90:1.85) -- (30:1.6) -- (330:1.5) -- (270:0.75) -- (210:1.75) -- (150:1.7) -- cycle;
    \draw[instgold, opacity=0.9, line width=2pt]
      (90:1.85) -- (30:1.6) -- (330:1.5) -- (270:0.75) -- (210:1.75) -- (150:1.7) -- cycle;
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Shield/defense visualization - enhanced for visibility
  \begin{scope}[shift={(5cm, -7cm)}]
    % Outer shield - increased line weight
    \draw[instgold, opacity=0.9, line width=2.5pt] (0,1.5) -- (2,0.5) -- (2,-1.5) -- (0,-2.5) -- (-2,-1.5) -- (-2,0.5) -- cycle;
    \draw[instgold, opacity=0.5, line width=1.5pt] (0,1.2) -- (1.6,0.4) -- (1.6,-1.2) -- (0,-2) -- (-1.6,-1.2) -- (-1.6,0.4) -- cycle;

    % Inner layers - increased opacity
    \fill[instgold, opacity=0.15] (0,0.9) -- (1.2,0.3) -- (1.2,-0.9) -- (0,-1.5) -- (-1.2,-0.9) -- (-1.2,0.3) -- cycle;
    \fill[instgold, opacity=0.25] (0,0.6) -- (0.8,0.2) -- (0.8,-0.6) -- (0,-1) -- (-0.8,-0.6) -- (-0.8,0.2) -- cycle;

    % Center - larger with clearer text
    \fill[instgold] (0,-0.2) circle (0.4);
    \node[instdark, font=\fontsize{8}{8}\selectfont\bfseries] at (0,-0.2) {CI};
  \end{scope}

  % Legend - improved visibility
  \node[white, opacity=0.7, font=\fontsize{8}{8}\selectfont\bfseries, anchor=west] at (10.5cm, -6cm) {DEFENSE-IN-DEPTH};
  \node[white, opacity=0.85, font=\fontsize{8}{8}\selectfont, anchor=west] at (10.5cm, -6.7cm) {Multi-layer controls};
  \node[white, opacity=0.85, font=\fontsize{8}{8}\selectfont, anchor=west] at (10.5cm, -7.4cm) {Identity verification};
  \node[white, opacity=0.85, font=\fontsize{8}{8}\selectfont, anchor=west] at (10.5cm, -8.1cm) {AI supply chain governance};
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Timeline visualization - enhanced for visibility
  \begin{scope}[shift={(3cm, -7.5cm)}]
    % Timeline line
    \draw[white, opacity=0.5, line width=2pt] (0,0) -- (12,0);

    % Year markers - larger and more visible
    \foreach \x/\year in {0/2025, 3/2026, 6/2028, 9/2029, 12/2030} {
      \fill[white, opacity=0.8] (\x,0) circle (0.12);
      \node[white, opacity=0.9, font=\fontsize{8}{8}\selectfont\bfseries] at (\x,-0.5) {\year};
    }

    % Current marker - more prominent
    \fill[instgold] (0,0) circle (0.25);
    \node[instgold, font=\fontsize{7}{7}\selectfont\bfseries] at (0,0.6) {NOW};

    % Transition zone - increased opacity
    \fill[warningamber, opacity=0.4] (1.5,-0.35) rectangle (7.5,0.35);
    \node[warningamber, font=\fontsize{7}{7}\selectfont\bfseries] at (4.5,0.7) {OFFENSE ADVANTAGE};

    % Equilibrium zone - increased opacity
    \fill[successgreen, opacity=0.3] (7.5,-0.35) rectangle (12,0.35);
    \node[successgreen, font=\fontsize{7}{7}\selectfont\bfseries] at (9.75,0.7) {EQUILIBRIUM?};
  \end{scope}
