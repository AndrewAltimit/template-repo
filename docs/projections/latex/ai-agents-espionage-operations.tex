...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(13.5cm, -7cm)}]
    ...
    % Legend (below radar - centered)
    \node[anchor=center] at (0,-2.1) {
      \begin{tikzpicture}
        \fill[coldsteel, opacity=0.5] (0,0) rectangle (0.25,0.12);
        \node[chromesilver, opacity=0.85, font=\fontsize{5}{5}\selectfont, anchor=west] at (0.35,0.06) {Traditional};
        \fill[signalcyan, opacity=0.6] (1.5,0) rectangle (1.75,0.12);
        \node[chromesilver, opacity=0.85, font=\fontsize{5}{5}\selectfont, anchor=west] at (1.85,0.06) {AI-Enabled};
      \end{tikzpicture}
    };
  \end{scope}
