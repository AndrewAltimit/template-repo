...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Encryption key / cipher visualization (improved)
  \begin{scope}[shift={(3cm, -7.5cm)}]
    % Key shaft with connected teeth
    \fill[chromesilver, opacity=0.35] (-0.1,-0.12) rectangle (2.8,0.12);
    % Key teeth pattern (connected to shaft)
    \foreach \x in {0.3,0.8,1.3,1.8,2.3} {
      \fill[signalred, opacity=0.7] (\x,-0.35) rectangle ({\x+0.2},0.12);
    }
    % Key head (bow)
    \fill[chromesilver, opacity=0.25] (3.2,0) circle (0.7);
    \draw[signalred, opacity=0.8, line width=2.5pt] (3.2,0) circle (0.55);
    \fill[signalred, opacity=0.4] (3.2,0) circle (0.35);
    % Connect shaft to head
    \fill[chromesilver, opacity=0.35] (2.5,-0.12) rectangle (3.2,0.12);

    % Binary/cipher stream below (improved visibility)
    \node[chromesilver, opacity=0.55, font=\fontsize{7}{7}\selectfont\ttfamily] at (1.8,-1.0) {01101001 01101110 01110100 01100101 01101100};
  \end{scope}

  % Cost comparison (right side - improved labels)
  \begin{scope}[shift={(10cm, -7.5cm)}]
    \draw[chromesilver, opacity=0.5, line width=1.2pt, -Stealth] (0,0) -- (4.5,0);
    \draw[chromesilver, opacity=0.5, line width=1.2pt, -Stealth] (0,0) -- (0,2);
    \node[chromesilver, opacity=0.75, font=\fontsize{7}{7}\selectfont\bfseries] at (4.8,0) {SCALE};
    \node[chromesilver, opacity=0.75, font=\fontsize{7}{7}\selectfont\bfseries] at (0,2.3) {COST};

    % Traditional curve (steep)
    \draw[coldsteel, opacity=0.8, line width=2pt] (0.2,0.2) .. controls (1,0.8) and (2.5,1.5) .. (4,2);
    \node[coldsteel, opacity=0.9, font=\fontsize{7}{7}\selectfont] at (4.4,1.7) {Trad.};

    % AI-enabled curve (flat)
    \draw[signalred, opacity=0.9, line width=2pt] (0.2,0.5) .. controls (1,0.6) and (2.5,0.7) .. (4,0.75);
    \node[signalred, font=\fontsize{7}{7}\selectfont] at (4.3,0.45) {AI};

    % Current marker (larger with readable NOW label)
    \fill[signalred] (2.8, 0.68) circle (0.18);
    \node[signalred, font=\fontsize{7}{7}\selectfont\bfseries] at (2.8, 1.1) {NOW};
  \end{scope}
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(3cm, -6.8cm)}]
    ...
    \draw[signalred, opacity=0.85, line width=1.5pt]
  ...
  \begin{scope}[shift={(11cm, -6.6cm)}]
    ...
    \node[anchor=west] at (0.8,-2.3) {
      \begin{tikzpicture}
        \fill[signalred, opacity=0.6] (0,0) rectangle (0.3,0.15);
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  % Shield icon (right side - enlarged lock)
  ...
  % Legend (with bullet indicators)
  \node[chromesilver, opacity=0.8, font=\fontsize{8}{8}\selectfont\bfseries, anchor=west] at (10cm, -5.2cm) {DEFENSE-IN-DEPTH};
  \fill[interceptgreen, opacity=0.7] (9.85cm, -5.8cm) circle (0.06);
  \node[interceptgreen, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -5.8cm) {Multi-layer controls};
  \fill[chromesilver, opacity=0.5] (9.85cm, -6.4cm) circle (0.06);
  \node[chromesilver, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -6.4cm) {Identity verification};
  \fill[chromesilver, opacity=0.5] (9.85cm, -7cm) circle (0.06);
  \node[chromesilver, opacity=0.9, font=\fontsize{7}{7}\selectfont, anchor=west] at (10cm, -7cm) {AI supply chain governance};
