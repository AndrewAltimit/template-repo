...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(4.5cm, -7cm)}]
    ...
    \fill[signalred, opacity=0.7] (0,1.2) rectangle (2.5,1.6);
  ...
  \begin{scope}[shift={(0.5\paperwidth-1.5cm, -7cm)}]
    ...
    % Supply curve (upward)
    \draw[signalred, opacity=0.9, line width=2pt] (0.3,0.3) .. controls (1,0.7) and (2,1.3) .. (2.8,1.7);
    % Intersection point
  ...
  \begin{scope}[shift={(13cm, -7cm)}]
    ...
    \fill[signalred] (3.5,0.8) circle (0.18);
    \draw[signalred, opacity=0.5, line width=1pt] (3.5,0.8) circle (0.35);
    % Progress arrow above
    \draw[signalred, opacity=0.7, line width=1.5pt, -Stealth] (0.5,1.3) -- (3.3,1.3);
    % Label
