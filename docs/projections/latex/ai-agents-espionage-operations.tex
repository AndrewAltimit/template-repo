...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[shadowdark, font=\small\bfseries\sffamily] at ([yshift=-1.85cm]current page.north) {PROJECTION REPORT \textbar{} ETRA-2025-ESP-001 \textbar{} DECEMBER 2025};
...
\toprule
\textbf{Aspect} & \textbf{Traditional Phishing} & \textbf{Spearphishing 1.0} & \textbf{GenSP (2025)} \\
\midrule
...
\noindent\hspace*{-0.85in}\begin{tikzpicture}
  ...
  \begin{scope}[shift={(2.5cm, -6.8cm)}]
    ...
    % Year markers
    \foreach \x/\year in {0/2025, 2.33/2026, 4.66/2028, 7/2030} {
  ...
  \begin{scope}[shift={(13cm, -7.2cm)}]
    ...
    % Scenario bars
    % Offense dominance
    \fill[steelblue, opacity=0.6] (0,0.8) rectangle (1.4,1.0);
    \fill[steelblue, opacity=0.3] (1.4,0.8) rectangle (4,1.0);
    \node[chromesilver, opacity=0.85, font=\fontsize{6}{6}\selectfont, anchor=west] at (4.2,0.9) {35\%};
    \node[chromesilver, opacity=0.7, font=\fontsize{6}{6}\selectfont, anchor=east] at (-0.1,0.9) {Offense};

    % Equilibrium
    \fill[interceptgreen, opacity=0.6] (0,0.2) rectangle (1.6,0.4);
    \fill[interceptgreen, opacity=0.3] (1.6,0.2) rectangle (4,0.4);
    \node[chromesilver, opacity=0.85, font=\fontsize{6}{6}\selectfont, anchor=west] at (4.2,0.3) {40\%};
...
\textbf{To test the claim that offense-defense favors attackers (2025--2028), monitor:}
...
\begin{itemize}
  ...
  \item \textbf{Current (late 2025)}: Claude Haiku 4.5: \$1/\$5 per 1M tokens; Claude Sonnet 4.5: \$3/\$15 per 1M tokens
  ...
  \item \textbf{85--90\% reduction}: Calculated from GPT-4-Turbo (early 2024) to Haiku 4.5 (late 2025)
...
\vspace{1cm}
\begin{center}
\textbf{Document Version}: 1.4 (Revised - Committee Submission)\\
