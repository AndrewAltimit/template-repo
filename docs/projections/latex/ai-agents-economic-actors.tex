...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-2.8cm, yshift=4.2cm]current page.center)}]

    % T0 - Tool (bottom tier) - widest
    \fill[networkblue, opacity=0.2] (-5.6, -5.4) -- (5.6, -5.4) -- (4.8, -3.8) -- (-4.8, -3.8) -- cycle;
    \fill[networkblue, opacity=0.45] (-4.8, -5.1) -- (4.8, -5.1) -- (4.1, -4.1) -- (-4.1, -4.1) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -4.6) {T0: TOOL ASSISTANCE};

    % T1 - Supervised (second tier)
    \fill[companyblue, opacity=0.2] (-4.8, -3.5) -- (4.8, -3.5) -- (4.0, -1.9) -- (-4.0, -1.9) -- cycle;
    \fill[companyblue, opacity=0.45] (-4.1, -3.2) -- (4.1, -3.2) -- (3.4, -2.2) -- (-3.4, -2.2) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -2.7) {T1: SUPERVISED AGENT};

    % T2 - Bounded (third tier)
    \fill[agentgreen, opacity=0.2] (-4.0, -1.6) -- (4.0, -1.6) -- (3.2, 0.0) -- (-3.2, 0.0) -- cycle;
    \fill[agentgreen, opacity=0.45] (-3.4, -1.4) -- (3.4, -1.4) -- (2.7, -0.3) -- (-2.7, -0.3) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -0.8) {T2: BOUNDED AUTONOMY};

    % T3 - Full Economic Agent (fourth tier)
    \fill[digitalgold, opacity=0.2] (-3.2, 0.3) -- (3.2, 0.3) -- (2.4, 1.9) -- (-2.4, 1.9) -- cycle;
    \fill[digitalgold, opacity=0.55] (-2.7, 0.5) -- (2.7, 0.5) -- (2.0, 1.6) -- (-2.0, 1.6) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (0, 1.1) {T3: ECONOMIC AGENT};

    % T4 - Organizational (top tier - brightest, apex) - wider for text
    \fill[digitalgold, opacity=0.35] (-2.4, 2.2) -- (2.4, 2.2) -- (1.6, 3.8) -- (-1.6, 3.8) -- cycle;
    \fill[digitalgold, opacity=0.85] (-2.0, 2.4) -- (2.0, 2.4) -- (1.3, 3.5) -- (-1.3, 3.5) -- cycle;
    \node[deepindigo, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (0, 3.0) {T4: ORGANIZATIONAL};

    % Ascending arrow on left - aligned with larger pyramid
    \draw[white, opacity=0.25, line width=1.5pt, ->] (-6.2, -5.4) -- (-6.2, 3.8);
    \node[white, opacity=0.4, font=\fontsize{7}{7}\selectfont\sffamily, rotate=90] at (-6.7, -0.8) {INCREASING AUTONOMY};

    % THE GAP - Diverging lines visualization (wider, shorter)
    \begin{scope}[shift={(6.3, -0.8)}]
      % Gap background - wider and shorter
      \fill[black, opacity=0.25, rounded corners=4pt] (-0.8, -3.2) rectangle (7.0, 2.8);

      % Title
      \node[governancered, font=\fontsize{11}{11}\selectfont\sffamily\bfseries] at (3.1, 2.3) {THE GAP};

      % Fill the widening gap area between the curves
      \fill[governancered, opacity=0.2]
        (-0.2, -2.2) -- (4.5, 1.5) -- (4.5, -1.0) -- (-0.2, -2.2) -- cycle;

      % Capability line (steep rise - green)
      \draw[agentgreen, line width=3pt] (-0.2, -2.2) -- (4.5, 1.5);
      \node[agentgreen, font=\fontsize{7}{7}\selectfont\sffamily, anchor=south west] at (4.6, 1.4) {CAPABILITY};

      % Governance line (slow rise - red)
      \draw[governancered, line width=3pt] (-0.2, -2.2) -- (4.5, -1.0);
      \node[governancered, font=\fontsize{7}{7}\selectfont\sffamily, anchor=north west] at (4.6, -1.0) {GOVERNANCE};

      % Starting point marker
      \fill[white] (-0.2, -2.2) circle (0.12);

      % Gap arrow and label (at right edge between endpoints)
      \draw[digitalgold, line width=1.5pt, <->] (5.9, -0.9) -- (5.9, 1.4);
      \node[digitalgold, font=\fontsize{7}{7}\selectfont\sffamily\bfseries, rotate=90] at (6.4, 0.25) {WIDENING};

      % Time axis labels
      \node[white, opacity=0.6, font=\fontsize{6}{6}\selectfont\sffamily] at (-0.2, -2.6) {2024};
      \node[white, opacity=0.6, font=\fontsize{6}{6}\selectfont\sffamily] at (4.5, -2.6) {2030};
      \draw[white, opacity=0.3, line width=0.5pt] (-0.2, -2.4) -- (4.5, -2.4);
    \end{scope}
