...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \begin{scope}[shift={([xshift=-1cm, yshift=1.5cm]current page.center)}]
    ...
    \node[white, font=\fontsize{9}{9}\selectfont\bfseries\sffamily] at (0,0.15) {AUTONOMOUS};
    \node[white, font=\fontsize{9}{9}\selectfont\bfseries\sffamily] at (0,-0.15) {AGENT};
    ...
    \begin{scope}[shift={(3.5, 1.5)}]
      ...
      \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0,0.85) {COMPANY};
    \end{scope}
    ...
    \begin{scope}[shift={(-3.5, 1.2)}]
      ...
      \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0,0) {INVESTOR};
    \end{scope}
    ...
    \begin{scope}[shift={(2.5, -2.5)}]
      ...
      \node[white, font=\fontsize{7}{7}\selectfont\sffamily] at (0,0.1) {TASK};
      \node[white, font=\fontsize{7}{7}\selectfont\sffamily] at (0,-0.2) {MARKET};
    \end{scope}
    ...
    \begin{scope}[shift={(-2.8, -2.0)}]
      ...
      \node[white, font=\fontsize{7}{7}\selectfont\sffamily] at (0,0) {COMPUTE};
    \end{scope}
    ...
    % Flow labels - improved size and contrast
    \node[digitalgold, font=\fontsize{7}{7}\selectfont\sffamily\bfseries] at (1.9,1.0) {FOUNDS};
    \node[investorpurple, font=\fontsize{7}{7}\selectfont\sffamily\bfseries] at (-1.9,0.9) {CAPITAL};
    \node[agentgreen, font=\fontsize{7}{7}\selectfont\sffamily\bfseries] at (1.6,-1.2) {TASKS/PAY};
    \node[networkblue, font=\fontsize{7}{7}\selectfont\sffamily\bfseries] at (-1.6,-0.9) {RESOURCES};
  \end{scope}

  % Governance gap indicator - right side (improved contrast and readability)
  \begin{scope}[shift={([xshift=5.5cm, yshift=1.5cm]current page.center)}]
    \fill[black, opacity=0.25, rounded corners=4pt] (-0.5, -2.5) rectangle (4.0, 2.5);

    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries, anchor=west] at (-0.2, 2.0) {THE GAP};
    \draw[white, opacity=0.4, line width=0.5pt] (-0.2, 1.7) -- (3.6, 1.7);

    % CAN section
    \node[agentgreen, font=\fontsize{8}{8}\selectfont\sffamily\bfseries, anchor=west] at (-0.1, 1.2) {AGENTS CAN:};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, 0.7) {Earn cryptocurrency};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, 0.3) {Form companies};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, -0.1) {Hire sub-agents};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, -0.5) {Seek investment};

    % Divider
    \draw[governancered, opacity=0.8, line width=1pt, dashed] (-0.2, -0.9) -- (3.6, -0.9);

    % CANNOT section
    \node[governancered, font=\fontsize{8}{8}\selectfont\sffamily\bfseries, anchor=west] at (-0.1, -1.3) {AGENTS CANNOT:};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, -1.7) {Sign binding contracts};
    \node[white, font=\fontsize{7}{7}\selectfont\sffamily, anchor=west, text width=3.5cm] at (-0.1, -2.1) {Pay taxes / Be liable};
  \end{scope}
