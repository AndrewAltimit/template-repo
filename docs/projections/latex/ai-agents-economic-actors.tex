...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % Diagonal flowing lines background (economic flow aesthetic)
  \begin{scope}[shift={(current page.center)}, opacity=0.04]
    \foreach \i in {-15,-13,...,15} {
      \draw[white, line width=0.8pt] (-12, \i) -- (12, \i+6);
    }
  \end{scope}

  % Main visualization - Ascending Autonomy Tiers with Gap
  \begin{scope}[shift={([xshift=-2.8cm, yshift=1.8cm]current page.center)}]

    % Subtle glow behind pyramid
    \fill[digitalgold, opacity=0.05] (0, -0.3) circle (6cm);

    % T0 - Tool (bottom tier) - widest
    \fill[networkblue, opacity=0.2] (-5.6, -4.0) -- (5.6, -4.0) -- (4.8, -2.8) -- (-4.8, -2.8) -- cycle;
    \fill[networkblue, opacity=0.45] (-4.8, -3.8) -- (4.8, -3.8) -- (4.1, -3.0) -- (-4.1, -3.0) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -3.4) {T0: TOOL ASSISTANCE};

    % T1 - Supervised (second tier)
    \fill[companyblue, opacity=0.2] (-4.8, -2.6) -- (4.8, -2.6) -- (4.0, -1.4) -- (-4.0, -1.4) -- cycle;
    \fill[companyblue, opacity=0.45] (-4.1, -2.4) -- (4.1, -2.4) -- (3.4, -1.6) -- (-3.4, -1.6) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -2.0) {T1: SUPERVISED AGENT};

    % T2 - Bounded (third tier)
    \fill[agentgreen, opacity=0.2] (-4.0, -1.2) -- (4.0, -1.2) -- (3.2, 0.0) -- (-3.2, 0.0) -- cycle;
    \fill[agentgreen, opacity=0.45] (-3.4, -1.0) -- (3.4, -1.0) -- (2.7, -0.2) -- (-2.7, -0.2) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily] at (0, -0.6) {T2: BOUNDED AUTONOMY};

    % T3 - Full Economic Agent (fourth tier)
    \fill[digitalgold, opacity=0.2] (-3.2, 0.2) -- (3.2, 0.2) -- (2.4, 1.4) -- (-2.4, 1.4) -- cycle;
    \fill[digitalgold, opacity=0.55] (-2.7, 0.4) -- (2.7, 0.4) -- (2.0, 1.2) -- (-2.0, 1.2) -- cycle;
    \node[white, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (0, 0.8) {T3: ECONOMIC AGENT};

    % T4 - Organizational (top tier - brightest, apex) - wider for text
    \fill[digitalgold, opacity=0.35] (-2.4, 1.6) -- (2.4, 1.6) -- (1.6, 2.8) -- (-1.6, 2.8) -- cycle;
    \fill[digitalgold, opacity=0.85] (-2.0, 1.8) -- (2.0, 1.8) -- (1.3, 2.6) -- (-1.3, 2.6) -- cycle;
    \node[deepindigo, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (0, 2.2) {T4: ORGANIZATIONAL};

    % Ascending arrow on left - aligned with larger pyramid
    \draw[white, opacity=0.25, line width=1.5pt, ->] (-6.2, -4.0) -- (-6.2, 2.8);
    \node[white, opacity=0.4, font=\fontsize{7}{7}\selectfont\sffamily, rotate=90] at (-6.7, -0.6) {INCREASING AUTONOMY};

    % THE GAP - refined visualization on right side
    \begin{scope}[shift={(7.5, -0.65)}]
      % Gap background - aligned with pyramid height
      \fill[black, opacity=0.25, rounded corners=4pt] (-1.0, -3.15) rectangle (4.0, 3.15);

      % Title - centered
      \node[governancered, font=\fontsize{11}{11}\selectfont\sffamily\bfseries] at (1.5, 2.6) {THE GAP};
      \draw[governancered, opacity=0.5, line width=1pt] (-0.6, 2.2) -- (3.6, 2.2);

      % Capability bar (tall, green) - better proportioned
      \fill[agentgreen, opacity=0.25] (-0.5, -2.6) rectangle (0.8, 1.7);
      \fill[agentgreen, opacity=0.65] (-0.3, -2.4) rectangle (0.6, 1.5);
      \node[white, font=\fontsize{7}{7}\selectfont\sffamily, rotate=90] at (0.15, -0.4) {CAPABILITY};

      % Governance bar (short, red) - better proportioned
      \fill[governancered, opacity=0.25] (2.2, -2.6) rectangle (3.5, -0.3);
      \fill[governancered, opacity=0.65] (2.4, -2.4) rectangle (3.3, -0.5);
      \node[white, font=\fontsize{7}{7}\selectfont\sffamily, rotate=90] at (2.85, -1.45) {GOVERNANCE};

      % Gap indicator arrow - centered between bars
      \draw[digitalgold, line width=2pt, <->] (0.9, 0.8) -- (2.1, 0.8);
      \node[digitalgold, font=\fontsize{8}{8}\selectfont\sffamily\bfseries] at (1.5, 1.2) {WIDENING};

      % Year labels - aligned
      \node[white, opacity=0.6, font=\fontsize{6}{6}\selectfont\sffamily] at (0.15, -2.8) {2025};
      \node[white, opacity=0.6, font=\fontsize{6}{6}\selectfont\sffamily] at (2.85, -2.8) {2025};
    \end{scope}
...
\begin{tikzpicture}[scale=0.95]
  ...
  \fill[companyblue] (2.7, 0.55) circle (3pt);
  \node[font=\scriptsize\sffamily, anchor=west, text width=2cm] at (2.9, 0.75) {ChatGPT\\launch};

  \fill[companyblue] (4.5, 1.8) circle (3pt);
  \node[font=\scriptsize\sffamily, anchor=west, text width=2cm] at (4.7, 2.0) {Agent\\frameworks};

  \fill[companyblue] (6.2, 3.4) circle (3pt);
  \node[font=\scriptsize\sffamily, anchor=east, text width=2cm, align=right] at (6.0, 3.7) {Economic\\participation};
...
\begin{tikzpicture}[scale=0.85, transform shape]
  ...
  % Legend
  \node[font=\scriptsize\sffamily] at (3.5*\cellw, -2.3*\cellh) {Legend:};
  \fill[governancered!90] (4.5*\cellw, -2.5*\cellh) rectangle (4.8*\cellw, -2.1*\cellh);
  \node[font=\tiny\sffamily, anchor=west] at (4.9*\cellw, -2.3*\cellh) {Critical gap};
  \fill[governancered!60] (5.8*\cellw, -2.5*\cellh) rectangle (6.1*\cellw, -2.1*\cellh);
  \node[font=\tiny\sffamily, anchor=west] at (6.2*\cellw, -2.3*\cellh) {Significant};
  \fill[digitalgold!60] (7.1*\cellw, -2.5*\cellh) rectangle (7.4*\cellw, -2.1*\cellh);
  \node[font=\tiny\sffamily, anchor=west] at (7.5*\cellw, -2.3*\cellh) {Moderate};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=2cm, auto, scale=0.9, transform shape]
  ...
  \draw[->, line width=0.5pt, dashed, governancered] (ops) to[bend right=40] node[below right, font=\scriptsize, governancered] {regression possible} (dev);
\end{tikzpicture}
\end{center}
